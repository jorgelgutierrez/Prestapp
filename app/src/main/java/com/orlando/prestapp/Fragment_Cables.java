...
public class Fragment_Cables extends Fragment {

    ListView Lista_Stock;
    ArrayList<String> stock = new ArrayList<String>();

    public Fragment_Cables() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fragment__cables, container, false);
        Lista_Stock = (ListView) view.findViewById(R.id.lista_stock_cables);
        Lista_Stock.setEnabled(false);

        //Agregando los items de cables...
        new ConsultarStock().execute("Cables");
        return  view;
    }
    ...
    private class ConsultarStock extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                Adaptador_Stock_TipoEquipo adapter = new Adaptador_Stock_TipoEquipo(getContext(),R.layout.item_stock_tipoequipo,stock,"Cables");
