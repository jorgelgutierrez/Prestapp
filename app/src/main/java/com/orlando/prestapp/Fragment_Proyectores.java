...
public class Fragment_Proyectores extends Fragment {


    ListView Lista_Stock;
    ArrayList<String> stock = new ArrayList<String>();

    public Fragment_Proyectores() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fragment__proyectores, container, false);
        Lista_Stock = (ListView) view.findViewById(R.id.lista_stock_proyectores);
        Lista_Stock.setEnabled(false);

        //Agregando los items de cables...
        new ConsultarStock().execute("Proyectores");
        return  view;
    ...
    private class ConsultarStock extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                Adaptador_Stock_TipoEquipo adapter = new Adaptador_Stock_TipoEquipo(getContext(),R.layout.item_stock_tipoequipo,stock,"Proyectores");
